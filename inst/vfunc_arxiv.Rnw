...
furnishes some ways to apply {\tt Arith} methods for functions.  For
example:
...
\sin(0.32^2+3) - 3\cdot\sin 0.32\cdot(0.32^2+3)$.  In base R:
...
l(sin(sin(0.4) + tan(0.4)), cos(sin(0.4) + tan(0.4)) + exp(sin(0.4) + tan(0.4)))
@
